...
def get_model(model_name):
    ...
    """
    # Try with original case first (for models like 'SEA')
    module_path = f'models.{model_name}'
    
    # check if the module exists with original case
    if importlib.util.find_spec(module_path) is not None:
        ...
        try:
            ...
            raise ValueError(f"Model class {model_name} not found in module {module_path}. Please check the model name and ensure the class exists in the module.")
    
    # # If original case doesn't work, try lowercase
    # model_file_name = model_name.lower()
    # module_path = f'models.{model_file_name}'
    
    # # check if the module exists with lowercase
    # if importlib.util.find_spec(module_path) is None:
    #     raise ValueError(f"Module {module_path} not found. Please check the model name and ensure the module exists.")
